package com.abdullahsoubeih.usingretrofitwihsql.RecyclerViewWithApi;
...
import com.abdullahsoubeih.usingretrofitwihsql.RecyclerViewWithApi.controller.DetailActivity;
...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ItemAdapter.ViewHolder viewHolder, int i) {
        ...
        if (items.get(i).getHtmlUrl() != null){
            viewHolder.githublink1.setVisibility(View.VISIBLE);
        }
